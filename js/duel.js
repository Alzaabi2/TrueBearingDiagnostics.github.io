...
window.curl && alert("DUEL included more than once!"),
    ...
    function () {
        ...
        if (a(b.env) || (b.env = "prod"), b.env_cdn = "wsimg.com", b.proto = "https:" == document.location.protocol ? "https:" : "http:", a(b.plabel) || (b.plabel = 1), b.plabel = "" + b.plabel, a(b.skin) || (b.skin = "app"), !a(b.theme)) switch (b.skin) {
            case "app":
        ...
        a(b.culture) || (b.culture = "en"), a(b.preload) || (b.preload = 1), a(b.loader) || (b.loader = 2), a(b.base) || (b.base = {}), a(b.util) || (b.util = {}), a(b.getjQuery) || (b.getjQuery = function () {
            return window.jQuery
        }), a(b.require) || (b.require = {}), "string" == typeof b.require.local && (b.preload = 0, b.loader = 1), a(b.require.js_root) || (b.require.js_root = b.proto + "//img4." + b.env_cdn + "/starfield/duel/v2.5.8"), a(b.require.img5_root) || (b.require.img5_root = b.proto + "//img5." + b.env_cdn + "/starfield/duel/v2.5.8"), a(b.require.jquery) || (b.require.jquery = b.proto + "//img4.wsimg.com/starfield/jquery/v1.7.2/jquery.js"), a(b.require.css_root) || (b.require.css_root = b.proto + "//img2." + b.env_cdn + "/starfield/duel/v2.5.8"), a(b.require.img_root) || (b.require.img_root = b.proto + "//img1." + b.env_cdn + "/starfield/duel/v2.5.8"), a(b.require.core) || (b.require.core = b.require.js_root + "/starfield/duel/v2.5.8/sf.core/sf.core"), a(b.require.core_css) || (b.require.core_css = b.require.css_root + "/starfield/duel/v2.5.8/sf.core/sf.core." + b.theme + ".css"), a(b.bundle) || (b.bundle = {});
        var g = b.bundle;
        g["sf.growl"] = g["sf.tabs"] = g["sf.dialog"] = g["sf.alerts"] = g["sf.msg.overlay"] = g["sf.base.dialog"] = g["sf.base.modal"] = g["sf.base.flyout"] = g["sf.i18n/duel"] = "sf.core.pkg";
        var h = {
            pluginPath: b.require.js_root + "/curl/plugin",
            paths: {},
            apiName: "require"
        };
        if ("string" == typeof b.baseUrl && (h.baseUrl = b.baseUrl), "undefined" != typeof b.debug && (h.debug = b.debug), "object" == typeof b.require.paths)
    ...
    function (a) {
        ...
        function d(a) {
            var b, c;
            return b = a.path = f(a.path || a.location || ""), c = a.main || "main", a.config = a.config, a.main = "." == c.charAt(0) ? f(g(c, b)) : e(b, c), a
        }
        ...
        function g(a, b) {
            var c, d, e;
            return d = 1, a = a.replace(J, function (a, b, c) {
                return c && d++, e = !0, ""
            }), e ? (c = b.split("/"), c.splice(c.length - d, d), c.concat(a || []).join("/")) : a
        }
        ...
        function n(a, b, c) {
            return function () {
                var d;
                return --a >= 0 && b && (d = b.apply(q, arguments)), 0 == a && c && c(d), d
            }
        }
        ...
        function o() {
            function a(b, c, d) {
                var e, f;
                f = t.createContext(v, q, [].concat(b)), this.then = e = function (a, b) {
                    return m(f, function (b) {
                        a && a.apply(q, b)
                    }, function (a) {
                        if (!b) throw a;
                        b(a)
            ...
            return c(b[0], "Object") && (v = t.extractCfg(b.shift()), t.checkPreloads(v)), new a(b[0], b[1])
        }
        ...
        if (t = {
                createContext: function (a, b, d, e) {
                    ...
                    function i(b, d) {
                        ...
                        if (e = d && function () {
                            ...
                            if (g = f(b), h = F[g], i = l(h) && h.exports, !(g in F)) throw new Error("Module not resolved: " + g);
                    ...
                    var j;
                    return j = new k, j.ctxId = j.id = b || "", j.isPreload = e, j.depNames = d, j.require = i, i.toUrl = h, j.toAbsId = f, j
                },
                createResourceDef: function (a, b, c, d) {
                    var e, f, g, h;
                    return e = t.createContext(a, b, q, c), e.ctxId = d == q ? b : d, f = e.resolve, g = n(1, function (a) {
                        e.deps = a;
                        try {
                ...
                extractCfg: function (a) {
                    function b(b, c) {
                        var g, i, k, l, m, n;
                        for (var o in b) k = b[o], m = a, l = h(f(k.id || k.name || o)), g = l.resourceId, i = l.pluginId, i && (m = e[i], m || (m = e[i] = j(a), m.pathMap = j(a.pathMap), m.pathList = []), delete b[o]), n = c ? d(k) : {
                            path: f(k)
                        }, n.specificity = g.split("/").length, g ? (m.pathMap[g] = n, m.pathList.push(g)) : m.baseUrl = t.resolveUrl(k, a)
                    }
                    ...
                    var e;
                    a.baseUrl = a.baseUrl || "", a.pluginPath = "pluginPath" in a ? a.pluginPath : "curl/plugin", a.pathMap = {}, e = a.plugins = a.plugins || {}, a.pathList = [], b(a.paths, !1), b(a.packages, !0);
                    for (var g in e) {
                        var i = e[g].pathList;
                ...
                checkPreloads: function (a) {
                    var b;
                    b = a.preloads, b && b.length > 0 && m(G, function () {
                        G = t.getDeps(t.createContext(a, q, b, !0))
                    })
                },
                resolvePathInfo: function (a, b, c) {
                    var d, f, g, h, i;
                    return d = b.pathMap, c && b.pluginPath && a.indexOf("/") < 0 && !(a in d) && (a = e(b.pluginPath, a)), g = I.test(a) ? a : a.replace(b.pathRx, function (b) {
                        return f = d[b] || {}, i = !0, h = f.config, f.main && b == a ? f.main : f.path || ""
                    }), {
                        path: g,
                        config: h || v,
                        url: t.resolveUrl(g, b)
                    }
                },
                ...
                loadScript: function (b, c, d) {
                    function e(d) {
                        d = d || a.event, ("load" == d.type || C[g.readyState]) && (delete B[b.id], g.onload = g.onreadystatechange = g.onerror = "", c())
                    }
                    ...
                    g.onload = g.onreadystatechange = e, g.onerror = f, g.charset = "utf-8", g.async = !0, g.src = b.url, B[b.id] = g, x.insertBefore(g, y)
                },
                extractCjsDeps: function (a) {
                    var b, c, d = [];
                    return b = "string" == typeof a ? a : a.toSource ? a.toSource() : a.toString(), b.replace(K, "").replace(L, function (a, b, e) {
                        return e ? c = c == e ? q : c : c || d.push(b), ""
                    }), d
                },
                fixArgs: function (a) {
                    var b, d, e, f, g, h;
                    return g = a.length, e = a[g - 1], f = c(e, "Function") ? e.length : -1, 2 == g ? c(a[0], "Array") ? d = a[0] : b = a[0] : 3 == g && (b = a[0], d = a[1]), !d && f > 0 && (h = !0, d = ["require", "exports", "module"].slice(0, f).concat(t.extractCjsDeps(e))), {
                        id: b,
                        deps: d || [],
                        res: f >= 0 ? e : function () {
                            return e
                ...
                executeDefFunc: function (a) {
                    var b, c;
                    return c = a.cjs ? a.exports : q, b = a.res.apply(c, a.deps), b === q && a.exports && (b = a.module ? a.exports = a.module.exports : a.exports), b
                },
                defineResource: function (a, b) {
                    m(a.isPreload || G, function () {
                        a.res = b.res, a.cjs = b.cjs, a.depNames = b.deps, t.getDeps(a)
                    })
                },
                getDeps: function (a) {
                    function b(a, b, c) {
                    ...
                    function c(b, c) {
                        ...
                        d = n(1, function (a) {
                            ...
                            k(a, c)
                        }), f = t.fetchDep(b, a), g = l(f) && f.exports, g && e(g), m(f, d, a.reject, a.exports && function (a) {
                            f.exports && (a == z ? e(f.exports) : a == A && d(f.exports))
                        })
                    }
                    ...
                    var f, g, h, i, j, k, o;
                    for (h = [], g = a.depNames, i = g.length, 0 == g.length && d(), k = n(i, b, e), o = n(i, b, d), f = 0; i > f; f++) j = g[f], j in s ? (o(s[j](a), f, !0), a.exports && a.progress(z)) : j ? c(j, f) : o(q, f, !0);
                    return a
                },
                fetchResDef: function (a) {
                    return t.getDefUrl(a), t.loadScript(a, function () {
                        var b = r;
                        r = q, a.useNet !== !1 && (!b || b.ex ? a.reject(new Error((b && b.ex || "define() missing or duplicated: url").replace("url", a.url))) : t.defineResource(a, b))
                    }, a.reject), a
                },
                fetchDep: function (a, b) {
                    var c, d, e, f, g, i, j, l, n, o;
                    return c = b.toAbsId, d = b.isPreload, e = h(a), i = e.resourceId, f = c(e.pluginId || i), j = t.resolvePathInfo(f, v, !!e.pluginId), e.pluginId ? g = f : (g = j.config.moduleLoader, g && (i = f, f = g, j = t.resolvePathInfo(g, v))), l = F[f], f in F || (l = F[f] = t.createResourceDef(j.config, f, d, e.pluginId ? j.path : q), l.url = t.checkToAddJsExt(j.url), t.fetchResDef(l)), f == g && (n = new k, o = v.plugins[g] || v, m(l, function (a) {
                        var b, e, f;
                        if (f = a.dynamic, i = "normalize" in a ? a.normalize(i, c, o) || "" : c(i), e = g + "!" + i, b = F[e], !(e in F)) {
                            b = t.createPluginDef(o, e, d, i), f || (F[e] = b);
                            var h = function (a) {
                                b.resolve(a), f || (F[e] = a)
                            };
                            h.resolve = h, h.reject = b.reject, a.load(i, b.require, h, o)
                        }
            ...
            var M, N, O;
            M = v.apiName || "curl", N = v.apiContext || a, N[M] = o, F.curl = o, O = a.define = function () {
    ...
    function (a, b) {
        ...
        var g, h, i, j, k, l = "readyState",
            ...
            q = 10,
            r = [];
        g = "addEventListener" in a ? function (a, b) {
        ...
        }, b && (e() || (r = [g(a, "load"), g(b, "readystatechange"), g(a, "DOMContentLoaded")], i = setTimeout(f, q))), define("curl/domReady", function () {
            function a(a) {
                p ? a() : n.push(a)
            }
            return a.then = a, a.amd = !0, a
        })
    }(this, this.document), define("domReady", ["curl/domReady"], function (a) {
        return {
        ...
        return {
            load: function (a, b, c, d) {
                ...
                b([a], function (a) {
                    "function" == typeof a.then ? a.then(function (b) {
    ...
    function (a, b, c) {
        define("js", ["curl/_privileged"], function (a) {
            ...
            function f(a, b) {
                e(a, function () {
                    var c = j.shift();
                    g = j.length > 0, c && f.apply(null, c), b.resolve(a.resolved || !0)
                }, function (a) {
                    b.reject(a)
                })
            }
            ...
            return {
                ...
                load: function (a, b, c, l) {
                    var m, n, o, p, q, r;
                    m = a.indexOf("!order") > 0, n = a.indexOf("!exports="), o = n > 0 && a.substr(n + 9), p = "prefetch" in l ? l.prefetch : !0, a = m || n > 0 ? a.substr(0, a.indexOf("!")) : a, a in i ? c(i[a]) : (i[a] = h, q = {
                        name: a,
                        url: b.toUrl(d(a, "js")),
                        order: m,
                        exports: o,
                        ...
                        reject: c.reject || function (a) {
                            throw a
                        }
                    }, m && !k && g ? (j.push([q, r]), p && (q.mimetype = "text/cache", e(q, function (a) {
                        a && a.parentNode.removeChild(a)
                    }, function () {}), q.mimetype = "")) : (g = g || m, f(q, r)))
                }
            }
        })
    ...
    function (a) {
        ...
        function c(a, b) {
            var c = a.link;
            c[s] = c[t] = function () {
                c.readyState && "complete" != c.readyState || (x["event-link-onload"] = !0, k(a), b())
            }
        }
        ...
        function e(a) {
            for (var b, c, d = a.split("!"), e = 1; b = d[e++];) c = b.split("=", 2), d[c[0]] = 2 == c.length ? c[1] : !0;
            return d
        }

        function f(a, b) {
            document.createStyleSheet && (B || (B = document.createStyleSheet()), document.styleSheets.length >= 30 && l());
            var c = a[u]("link");
            return c.rel = "stylesheet", c.type = "text/css", c.setAttribute("_curl_movable", !0), b && (c.href = b), c
        }

        function g() {
            return C || (C = A[u]("div"), C.id = "_cssx_load_test", r.appendChild(C)), "-5px" == A.defaultView.getComputedStyle(C, null).marginTop
        }

        function h(a) {
            var b, c, d = !1;
            try {
                b = a.sheet || a.styleSheet, c = b.cssRules || b.rules, d = c ? c.length > 0 : c !== q, d && "[object Chrome]" == {}.toString.call(window.chrome) && (b.insertRule("#_cssx_load_test{margin-top:-5px;}", 0), d = g(), b.deleteRule(0))
            } catch (e) {
                d = 1e3 == e.code || 18 == e.code || e.message.match(/security|denied|insecure/i)
            }
            return d
        }

        function i(a, b) {
            h(a.link) ? (k(a), b()) : v || setTimeout(function () {
                i(a, b)
            }, a.wait)
        }
        ...
        function l() {
            var a, b, c, d = 0;
            for (c = B, B = null, b = document.getElementsByTagName("link"); a = b[d];) a.getAttribute("_curl_movable") ? (c.addImport(a.href), a.parentNode && a.parentNode.removeChild(a)) : d++
        }
        ...
        function o(a) {
            return clearTimeout(o.debouncer), o.accum ? o.accum.push(a) : (o.accum = [a], D = A.createStyleSheet ? A.createStyleSheet() : r.appendChild(A.createElement("style"))), o.debouncer = setTimeout(function () {
                var a, b;
                a = D, D = q, b = o.accum.join("\n"), o.accum = q, b = b.replace(/.+charset[^;]+;/g, ""), "cssText" in a ? a.cssText = b : a.appendChild(A.createTextNode(b))
            }, 0), D
        }
        ...
        function p(a) {
            return {
                ...
                insertRule: a.insertRule || function (b, c) {
                    var d = b.split(/\{|\}/g);
                    return a.addRule(d[0], d[1], c), c
                },
                deleteRule: a.deleteRule || function (b) {
                    ...
                    for (var l, n = i.length - 1; n >= 0; n--, l = !0) {
                        ...
                        var q = e(a),
                            ...
                            x = {
                                link: u,
                                url: t,
                                wait: g.cssWatchPeriod || 50
                            };
                        v ? c(p(u.sheet || u.styleSheet)) : j(x, h), u.href = t, l ? r.insertBefore(u, w[l].previousSibling) : r.appendChild(u), w[t] = u
                    } else c({
                        translateUrls: function (a, c) {
                            var d;
                            return d = b.toUrl(c), d = d.substr(0, d.lastIndexOf("/") + 1), m(a, d)
                        },
    ...
    }(this), define("jq", ["js"], function () {
        return {
            load: function (a, b, c, d) {
                function e(a) {
                    "undefined" == typeof a.expr[":"].focus && (a.expr[":"].focus = function (a) {
                ...
                return "undefined" != typeof jQuery ? void e(jQuery) : (a = "js!" + a, void b([a], function (a) {
                    "undefined" != typeof jQuery ? e(jQuery) : f("jQuery NOT defined!")
                }))
            }
        }
    }), define("text", function () {
        function a() {
            if ("undefined" != typeof XMLHttpRequest) a = function () {
                return new XMLHttpRequest
            };
            else
                for (var b = a = function () {
                        throw new Error("getXhr(): XMLHttpRequest not available")
                    }; d.length > 0 && a === b;)(function (b) {
                    try {
                        new ActiveXObject(b), a = function () {
        ...
        function b(b, c, d) {
            var e = a();
            e.open("GET", b, !0), e.onreadystatechange = function (a) {
                4 === e.readyState && (e.status < 400 ? c(e.responseText) : d(new Error("fetchText() failed. status: " + e.statusText)))
            }, e.send(null)
        }
        ...
        return {
            load: function (b, c, d, e) {
                ...
                function h(a, c) {
                    k.length > 1 && "object" == typeof c && i(c, a), "undefined" != typeof a ? f(a) : g("i18n failed on " + b)
                }
                ...
                function j() {
                    k.length > 1 ? (k.pop(), a(k).then(h, j)) : g("i18n cannot find " + b)
                }
                var k = [b];
                if ("en" != $sf.culture) {
                    var l = b.lastIndexOf("/");
        ...
        encode: function (a) {
            var b, c, d, e, f, g, h, i = "",
                j = 0;
            for (a = $sf.util.Base64._utf8_encode(a); j < a.length;) b = a.charCodeAt(j++), c = a.charCodeAt(j++), d = a.charCodeAt(j++), e = b >> 2, f = (3 & b) << 4 | c >> 4, g = (15 & c) << 2 | d >> 6, h = 63 & d, isNaN(c) ? g = h = 64 : isNaN(d) && (h = 64), i = i + this._keyStr.charAt(e) + this._keyStr.charAt(f) + this._keyStr.charAt(g) + this._keyStr.charAt(h);
            return i
        },
        decode: function (a) {
            var b, c, d, e, f, g, h, i = "",
        ...
        a.core.resolvePathInfo = function (d, e) {
            var f, g = (d in a.cache, /^(starfield|duel)\/([^\s]*.?)/i.exec(d));
            if (g && g.length >= 3) {
                var h = g[2];
                if ($sf.loader >= 2 && !c) {
                    var i = $sf.bundle[h];
                ...
                1 == j.length && (k = "/" + n + "/", ".css" == m && (h = $sf.theme + ".css")), f = {
                    config: e,
                    url: (c ? $sf.require.local : ".css" == m ? $sf.require.css_root : $sf.require.js_root) + k + h
        ...
        function a() {
            ...
            function b(c, d, e) {
                ...
                if (c && c.length > 0 && f) {
                    var g = a(c);
                    if (g > d && (d = g), 0 === d || e && f) return b(c.parent(), d, e)
                }
                return d
            }
            ...
            function d(b) {
                var c = "undefined" != typeof b ? b.children(":visible") : $sf.util.ua.ie ? $("body *") : $("*:visible"),
                    d = 0;
            ...
            function e(a) {
                var b = null;
                return a.parentsUntil("body").each(function () {
                    return "fixed" === $(this).css("position").toLowerCase() ? (b = $(this), !1) : void 0
                }), b
            }
            ...
            function f(a, b, c) {
                ...
                var h = "sflayer-" + f;
                if (0 === $("#" + h, b).length) {
                    $("<div />").addClass("sflayer sflayer-" + a).attr({
                        "data-sflayer": a,
                        "data-sflayerdeep": f,
                        id: h
                    }).appendTo(e)
            ...
            function g(a, b) {
                ...
                return b === !0 ? c.length > 0 ? c.eq(0).attr("data-sflayer") : "page" : c.length > 0 ? c.eq(0) : null
            }
            return {
                get: function (a) {
                    return b(a, 0, !1)
        ...
        function b(a, b) {
            ...
            var e = "string" == typeof b && window.location.href.indexOf(b + "=true") > -1 || "string" != typeof b,
                f = $sf.util.ua.ie && $sf.util.ua.major <= 7;
            return {
                log: function (a) {
                    e && (f ? alert(c + ": " + a) : d && console.log && console.log(c + a))
                },
                dir: function (a) {
        ...
        function c(a, b) {
            ...
            function d(d, e) {
                ...
                if (b !== a) {
                    ...
                    f.top = Math.ceil(f.top + g.top - (h ? $(b).scrollTop() : $(a).scrollTop())), f.left = Math.ceil(f.left + g.left - (h ? $(b).scrollLeft() : $(a).scrollLeft()))
                }
                return f
            }
            ...
            function e(e, f) {
                ...
                g.top += h ? $(a).scrollTop() : 0, g.left += h ? $(a).scrollLeft() : 0, g.right = Math.ceil(g.left + e.outerWidth()), g.bottom = Math.ceil(g.top + e.outerHeight()), j.left += $(a).scrollLeft(), j.top += $(a).scrollTop(), j.right = Math.ceil(j.left + $(i).width()), j.bottom = Math.ceil(j.top + $(i).height());
                var k = g.left >= j.left && g.right <= j.right && g.top >= j.top && g.bottom <= j.bottom;
                return k
            }
            var f = null;
            return {
        ...
        "undefined" == typeof $sf.util && ($sf.util = {}), $sf.util.zIndex = a(), $sf.util.logger = b, $sf.util.context = c, $sf.util.jCompat = d()
        ...
        $sf.util.module = function (a, b) {
            return function (c) {
                function d(a, d, e) {
                    ...
                    for (var g in b)
                        if (b.hasOwnProperty(g)) {
                            var h = b[g];
                            c.isPlainObject(h) ? f[g] = c.extend(!0, {}, f[g], h) : c.isArray(h) && (f[g] = c.merge([], h))
                        } f.options = c.extend(!0, {}, f.options, d), f.id = e, f.element = a, f._create(), f._init()
                }
                var e = "sf" + a,
                    f = "sf-" + a.toLowerCase();
                if ($sf || ($sf = {}), $sf.modules || ($sf.modules = {}), $sf.modules.instances || ($sf.modules.instances = {}), $sf.modules.ids || ($sf.modules.ids = {}), !$sf.modules.base) {
                    $sf.modules.base = function (a, b) {
                        return this.baseClass = b, this.pluginName = a, this.options.logFlag = "duel", this
                    };
                    var g = {
                        options: {},
                        _create: function () {},
                        ...
                        destroy: function (a) {
                            var b = this.id,
                                d = this.pluginName;
                            delete $sf.modules.instances[d][b], $sf.modules.ids[d] = c.grep($sf.modules.ids[d], function (a) {
                                return a.id != b
                            }), c.isFunction(a) && a()
                        },
                        _siblings: function () {
                        ...
                        _log: function (a) {
                            window.location.href.indexOf(this.options.logFlag + "=") > -1 && ($sf.util.ua.ie && $sf.util.ua.major <= 7 ? alert(this.id + ": " + a) : window.console && console.log && console.log(this.id + ": " + a))
                        },
                        _dir: function (a, b) {
                            window.location.href.indexOf(this.options.logFlag + "=") > -1 && ("string" == typeof b && b.length > 0 && this._log(b), $sf.util.ua.ie && $sf.util.ua.major <= 7 ? alert(JSON.parse(a)) : window.console && console.dir && console.dir(a))
                        },
                        _initElementId: function (a, b) {
                            var c = a.attr("id");
                            (null == c || 0 == c.length) && (c = this._generateId(b), a.attr("id", c))
                        },
                        _generateId: function (a) {
                            return a = a ? a : this.baseClass.toLowerCase(), a + "-" + Math.round(65535 * Math.random())
                        }
                    };
                    c.extend(!0, $sf.modules.base.prototype, g), $sf.modules.base.prototype._super = $sf.modules.base.prototype, $sf.modules.base.prototype._execSuper = function (a) {
                        var b = [];
                ...
                $sf.modules[e] = d, d.prototype = new $sf.modules.base(e, f), d.prototype.constructor = d, d.constructor = $sf.modules.base, c.extend(!0, d.prototype, b);
                var h = c.fn[e] = function (a, b) {
                    var f = "create";
                    a = "undefined" == typeof a ? {} : a, a.constructor === String && (f = a, a = b);
                    var g = {
                        initInstance: function (a) {
                            var b = c(a),
                                d = b.attr("id");
                            (null == d || 0 == d.length) && (d = e.toLowerCase() + Math.round(65535 * Math.random()), b.attr("id", d));
                            var f = $sf.modules.instances[e][d] = {};
                            return $sf.modules.ids[e].push(d), f.me = b, f.meId = d, d
                        },
                        initPlugin: function (a, b, f, h) {
                            var i = function () {
                                b = g.initInstance(f), $sf.modules.instances[e][b].module = new d(c(f), h, b)
                            };
                            if (a && a.module) {
                                var j = a.module;
                        ...
                        getOrDo: function (b, d, e) {
                            if (d && d.module) {
                                ...
                                if ("option" === b || "options" === b) {
                                    var i = f.options[a];
                                    return c.isPlainObject(i) && (i = c.extend(!0, {}, i)), h = i, !1
                                }
                                if ("_" !== b.slice(0, 1) && c.isFunction(f[b])) {
                                    var j = !1;
                                    return c.isArray(a) || (a = [a]), j = f[b].apply(f, a), "undefined" != typeof j && (h = j), !1
                                }
                                g.log("invalid command/property: " + b)
                            } else g.log("couldn't find instance for [" + e + "] to execute " + b)
                        },
                        log: function (a) {
                    ...
                    $sf.modules.instances[e] || ($sf.modules.instances[e] = {}), $sf.modules.ids[e] || ($sf.modules.ids[e] = []);
                    var h = this;
                    return this.each(function (b) {
                        ...
                        } else g.log("couldn't find instance for [" + d + "] to execute " + f)
                    }), h
                };
                return h
            }($sf.getjQuery())
            ...
            function a(a) {
                function c(a) {
                    a.t = a.t ? a.t : Math.floor(a.top - (r.t - p.top)), a.l = a.l ? a.l : Math.floor(a.left - (r.l - p.left)), a.w = a.w ? a.w : Math.floor(t.outerWidth()), a.h = a.h ? a.h : Math.floor(t.outerHeight()), a.width = function () {
                        return a.w
                    }, a.height = function () {
                        return a.h
                    }, a.r = a.l + a.w, a.b = a.t + a.h, a.hh = Math.floor(a.h / 2), a.m = a.t + a.hh, a.mt = a.m - Math.floor(s.height / 2), a.mb = a.m + Math.floor(s.height / 2), a.hw = Math.floor(a.w / 2), a.mc = a.m, a.c = a.l + a.hw, a.cl = a.c - Math.floor(s.width / 2), a.cr = a.c + Math.floor(s.width / 2), a.so = function (b) {
                ...
                function d(a, b, c, d) {
                    ...
                    var m = f.name,
                        n = h("x" === m ? f.v : y.opposite(e).v, "y" === m ? f.v : y.opposite(e).v, m),
                ...
                function e(a, b) {
                    return function () {
                        a._values = a._values || {};
                        var c = "";
                        if (void 0 === b || 0 === b.length) c = Array.prototype.join.call(arguments, "-");
                        else
                            for (var d = 0, e = b.length; e > d; d++) c += arguments[b[d]], e - 1 > d && (c += "-");
                        return void 0 !== a._values[c] ? a._values[c] : a._values[c] = a.apply(a, arguments)
                    }
                }
                ...
                function h(b, c, d, e) {
                    ...
                    var g = 0;
                    return a.centerAgainstAnchor === !0 ? g = "x" === d ? "fu".indexOf(c) > -1 && "lr".indexOf(b) > -1 ? u.hw * ("r" === b ? -1 : 1) : 0 : "lr".indexOf(b) > -1 && "tb".indexOf(c) > -1 ? u.hh * ("b" === c ? -1 : 1) : 0 : a.slideAgainstAnchor === !0 && "undefined" != typeof e && (g = "x" === d && b === w.mid ? f("l") + f("r") : "y" === d && c === x.mid ? f("t") + f("b") : f("x" === d ? w.opp(b) : x.opp(c))), g
                }

                function i(b) {
                    b = 1 !== b ? 0 : b;
                    for (var c = 0 === b, d = g(x.v, w.v, c), e = !(!y.tries[x.v + w.v].y && y.direction(x.v) < 0 || !y.tries[x.v + w.v].x && y.direction(w.v) > 0), f = a.forceIdeal ? {
                            y: x.v,
                            x: w.v
                        } : y.getNeighbor(x.v, w.v, e, a.path), h = 1; !d && 12 > h && f.y + f.x !== x.ideal + w.ideal;) d = g(f.y, f.x, c), h++, !d && 12 > h && ("clock" === a.path && 6 === h && (e = !e, f.y = x.ideal, f.x = w.ideal), f = y.getNeighbor(f.y, f.x, e, a.path));
                    if (!d)
                        if (0 === b) i(1);
                        else {
                            var k = u.w > s.width || u.h > s.height,
                                l = a.fallbackOnFailPosition;
                            l = k ? l : "ideal", "ideal" !== l && (l = "auto" === l ? "center viewport" : l, x.v + w.v !== "mc" && (w.v = "c", x.v = "m", "center viewport" === l && j()))
                        } return d
                }

                function j() {
                    o = l.containerOffset, p = l.anchorOffset, u = $.extend(!0, {
                        top: r.t,
                        left: r.l
                    }, r), c(u), a.forceIdeal = !0, n = "mc", a.centerAgainstAnchor = !1, a.slideAgainstAnchor = !1, i()
                }
                ...
                function k(a) {
                    var b = "x" === a ? "left" : "top",
                        ...
                        d = y.get(a);
                    C[c] = h(w.v, x.v, a, C[b]);
                    var e = Math.abs(C[c]) - Math.abs(s[d.dimension] / (d.mid === d.v ? 2 : 1));
                ...
                var m = a.container,
                    ...
                    u = t.offset();
                c(u);
                var v = "m" === n.substr(0, 1) || "c" === n.substr(1, 1) ? "cross" : "corners",
                    w = {
                        name: "x",
                        v: n.substr(1, 1),
                        ideal: n.substr(1, 1),
